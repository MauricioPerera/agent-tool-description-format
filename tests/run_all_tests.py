...
def run_all_tests():
    ...
    try:
        ...
        results.append(("Pruebas completas de ATDF", atdf_success, 
                       atdf_tester.success_count, atdf_tester.failure_count, atdf_tester.test_count))
    ...
    try:
        ...
        results.append(("Pruebas del agente trilingüe", trilingual_success,
                       trilingual_tester.success_count, trilingual_tester.failure_count, trilingual_tester.test_count))
    except Exception as e:
    ...
    try:
        ...
        results.append(("Pruebas de características mejoradas", enhanced_success,
                       enhanced_tester.success_count, enhanced_tester.failure_count, enhanced_tester.test_count))
    except Exception as e:
