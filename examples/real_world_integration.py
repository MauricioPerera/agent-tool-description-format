...
class HotelReservationAPI:
    ...
    def create_reservation(self, reservation_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        name_validation = self.validator.validate_string_length(
            reservation_data["guest_name"], "guest_name", min_length=2, max_length=100
        )
        if name_validation:
            ...
            return self.validator.create_error_response(
                ...
                expected={
                    ...
                    "examples": {
                        ...
                        "invalid": [
                            {"value": 0, "reason": "must be at least 1"},
                            {
                                "value": max_guests + 1,
                                "reason": f"exceeds limit for {room_type} room",
                            },
                            {"value": "2", "reason": "must be integer, not string"},
                        ],
                    },
                },
        ...
        if "special_requests" in reservation_data:
            ...
            if special_requests and len(special_requests) > 500:
                return self.validator.create_error_response(
                    ...
                    received={"length": len(special_requests), "max_length": 500},
                    expected={
                        "conditions": [
                            "Special requests must be 500 characters or less"
                        ],
                        "format": "Optional text string",
                        "constraints": {"max_length": 500, "optional": True},
                        "examples": {
                            "valid": [
        ...
        try:
            ...
            return self.validator.create_error_response(
                ...
                field="system",
                received={"error": str(e), "error_type": type(e).__name__},
                expected={
                    "conditions": [
    ...
    def get_reservation(self, reservation_id: str) -> Dict[str, Any]:
        ...
        if not re.match(r"^RES-\d{6}$", reservation_id):
            return self.validator.create_error_response(
                ...
                received={"provided_id": reservation_id},
                expected={
                    "conditions": [
                        "Must start with 'RES-'",
                    ...
                    "examples": {
                        ...
                        "invalid": [
                            {"value": "123456", "reason": "missing RES- prefix"},
                            {"value": "RES-123", "reason": "not enough digits"},
                            {"value": "RES-ABC123", "reason": "contains letters"},
                        ],
                    },
                },
        ...
        return self.validator.create_error_response(
            ...
            expected={
                "conditions": ["Reservation ID must exist in the system"],
