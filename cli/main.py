...
def validate(tool_path: str, smart: bool, schema: Optional[str], ignore_additional: bool):
    ...
    if smart:
        ...
        ok = validate_tool(source, schema_file=schema, ignore_additional_properties=ignore_additional)
...
@click.option('--language', '-l', help='Language code to bias selection (e.g., en, es).')
