...
const weatherToolATDF = {
  ...
  when_to_use:
    'Cuando necesites conocer las condiciones climáticas de una ubicación',
  how_to_use: {
    inputs: [
      {
        name: 'location',
...
async function main() {
  ...
  const fetchTool = createMCPToolFromATDF(fetchToolATDF, fetchImplementation);
