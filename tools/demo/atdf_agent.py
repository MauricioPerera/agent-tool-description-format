...
class ATDFTrilingualAgent:
    ...
    def _detect_language(self, text):
        ...
        keywords = {
            "es": ["hacer", "agujero", "traducir", "español", "herramienta", "para", "necesito", "quiero", "perforar"],
            "en": ["make", "hole", "translate", "english", "tool", "for", "need", "want", "drill"],
            "pt": ["fazer", "furo", "traduzir", "português", "ferramenta", "para", "preciso", "quero", "perfurar"]
        }
