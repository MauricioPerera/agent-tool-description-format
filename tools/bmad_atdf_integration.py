...
class BMadATDFIntegration:
    ...
    def __init__(self, project_root: Optional[str] = None):
        ...
        logger.info(f"BMad-ATDF Integration initialized for project: {self.project_root}")
    ...
    def create_bmad_tool_description(self, 
                                   tool_name: str, 
                                   description: str, 
    ...
    def generate_analyst_tools(self) -> List[Dict[str, Any]]:
        ...
        tools.append(self.create_bmad_tool_description(
            "analyze_atdf_schema",
        ...
        tools.append(self.create_bmad_tool_description(
            ...
            "Research existing tool description standards and compare with ATDF",
            {
                ...
                "comparison_criteria": {
                    ...
                    "default": ["expressiveness", "validation", "error_handling", "adoption"]
                }
            },
            "analyst"
        ))
    ...
    def generate_architect_tools(self) -> List[Dict[str, Any]]:
        ...
        tools.append(self.create_bmad_tool_description(
            ...
            "Design new ATDF schema components with architectural best practices",
            {
                "component_type": {
                    "type": "string",
                    "enum": ["tool_description", "error_response", "metadata", "validation"],
                ...
                "performance_constraints": {
                    "type": "object",
                    "properties": {
                        "max_validation_time_ms": {"type": "integer", "default": 100},
        ...
        tools.append(self.create_bmad_tool_description(
            ...
            "Test ATDF schema validation across different scenarios",
            {
                "test_scenarios": {
                    ...
                    "default": ["valid_input", "invalid_input", "edge_cases", "malformed_data"]
                },
                "schema_version": {
                    "type": "string",
    ...
    def save_agent_tools(self, tools_by_agent: Optional[Dict[str, List[Dict[str, Any]]]] = None):
        ...
        for agent_type, tools in tools_by_agent.items():
            ...
            logger.info(f"Saved {len(tools)} tools for {agent_type} agent: {agent_file}")
    ...
    def setup_bmad_environment(self):
        ...
        status = {
            "bmad_integration": {
                ...
                "tools_generated": sum(len(tools) for tools in self.generate_all_agent_tools().values()),
                "workflows_available": ["schema_enhancement", "tool_integration", "error_handling_improvement"]
            }
        }
