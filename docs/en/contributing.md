...
**Languages:** [English (en)](contributing.md) | [Español (es)](../es/contributing.md) | [Português (pt)](../pt/contributing.md)
...
- [ ] Reference the target schema version (see [Version Compatibility](version_compatibility.md)) and set `schema_version` explicitly.
...
- [ ] (Internal team) Attach or link internal workflow updates if the change impacts automation configs or integration scripts.
