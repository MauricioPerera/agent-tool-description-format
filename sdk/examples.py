...
def ejemplo_esquema_entradas(toolbox):
    ...
    print(f"Generando esquema de validación para la herramienta: {selected_tool.tool_id}")
...
def ejemplo_completo():
    ...
    peticion_usuario = "Necesito hacer un agujero en la pared para colgar un cuadro grande"
    ...
    if herramienta.feedback:
        ...
        print("   No hay preguntas de retroalimentación definidas para esta herramienta.")
