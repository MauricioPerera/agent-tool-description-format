...
def main_entry():
    ...
    parser = argparse.ArgumentParser(
        description="Búsqueda vectorial de herramientas ATDF"
    )

    parser.add_argument("--db-path", help="Ruta para la base de datos vectorial")

    parser.add_argument("--model", help="Modelo de embedding a utilizar")

    parser.add_argument("--index", help="Directorio con herramientas ATDF para indexar")

    parser.add_argument(
        "--query", help="Consulta en lenguaje natural para buscar herramientas"
    )
    ...
    parser.add_argument(
        "--output", help="Archivo para exportar resultados en formato JSON"
    )
